...
from langchain.agents import tool, AgentAction, AgentFinish
from langchain.prompts import PromptTemplate
from langchain.tools import render_text_description
...
if __name__ == "__main__":
    ...
    llm = ChatGroq(temperature=0, model_name="mixtral-8x7b-32768",stop = ["\nObservation:"])
    ...
    if isinstance(agent_step,AgentFinish):
        print(f"Agent finished with {agent_step.return_values=}")
